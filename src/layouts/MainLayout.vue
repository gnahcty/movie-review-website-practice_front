  ...
  <q-layout view="hHh lpR fFf">
    ...
    <q-header bordered class="bg-white text-black">
      <q-toolbar>
        ...
        <q-toolbar-title>
          <q-btn to="/" size="xl" flat color="primary" icon="img:https://stickershop.line-scdn.net/stickershop/v1/sticker/563671934/android/sticker.png?v=1" label="Title" />
        </q-toolbar-title>
        <q-btn flat round icon="format_list_bulleted" to="/lists" >
          <q-tooltip>Lists</q-tooltip>
          </q-btn>
        <q-btn flat round icon="fa-solid fa-skull" class="q-ma-lg" to="/users">
    ...
    <q-drawer v-model="leftDrawerOpen" side="left" overlay behavior="desktop" elevated>
      <q-scroll-area class="fit">
          <q-list>
            <q-item clickable v-ripple style="height:150px;">
        ...
        <q-item-section>
          <q-item-label line="1" class="text-h5 q-pl-lg">User Name</q-item-label>
        </q-item-section>
      </q-item>
